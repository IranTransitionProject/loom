        ...
        for child_type, child_ids in children.items():
            for child_id in child_ids:
                ...
                try:
                    ...
                    # Child already finalized via another path, or a
                    # domain rule. P3 (Sprint 3) catches children
                    # that never finalize via the horizon timeout.
                    pass
                except ConcurrencyError:
                    # Child concurrent mutation. Cascade is
                    # opportunistic; the next round of replay will
                    # re-try if needed.
                    pass
